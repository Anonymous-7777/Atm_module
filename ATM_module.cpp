   ...
   while(x>0)
    {
        ...
        {
            cout<<"\t \t choose 1 for viewing balance, choose 2 for depositing the money, choose 3 for withdrawing money"<<endl;
            cin>>input;
            system("cls");
            if(input==1)
            {
                cout<<"Your current bank balance is "<<endl<<"Rs. " << balance;
                getch();
            }
